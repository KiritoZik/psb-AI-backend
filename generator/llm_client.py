...
Содержит только низкоуровневую HTTP‑логику без доменных правил и шаблонов.
"""
...
class YandexGPTGenerator:
    ...
    def generate(
        ...
        """Генерация текста (одиночным запросом)."""
...
__all__ = ["YandexGPTGenerator", "get_generator"]
